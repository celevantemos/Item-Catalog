...
user1 = User(id=1, name='Mohammad Alhashim',
...
category7 = Category(id=7, name="Football", user_id=1)
session.add(category7)
session.commit()

category8 = Category(id=8, name="Skating", user_id=1)
session.add(category8)
session.commit()

category9 = Category(id=9, name="Hockey", user_id=1)
session.add(category9)
session.commit()

item1 = Items(id=1, name="Wold Cup 2018 Ball", description='''One of the best
labtops around the world''', category_id=1, user_id=1)
session.add(item1)
session.commit()

item2 = Items(id=2, name="Portable Basketball Hoop", description='''This
...
item3 = Items(id=3, name="Marucci CAT8 BBCOR Bat 2019", description='''One
...
item4 = Items(id=4, name="Club Jr Ultimate Gloves", description='''The gloves
...
item5 = Items(id=5, name="Men's Burton Custom Snowboard", description='''The
...
item6 = Items(id=6, name='''La Sportiva Tarantulace Climbing
...
item7 = Items(id=7, name='''Champro Man-Up TRI FLEX Adult 5 Pad Integrated
...
item8 = Items(id=8, name="SUPER TACKS AS1 STICK", description='''The new
...
item9 = Items(id=9, name='''adidas Cristiano Ronaldo Juventus
...
item10 = Items(id=10, name='''Nike SuperflyX 6 Elite IC Black Total
...
item11 = Items(id=11, name='''Nike Merlin Match Soccer
...
item12 = Items(id=12, name='''Nike Ordem V Match Soccer Ball
...
item13 = Items(id=13, name='''Reusch Prisma Supreme G3 Fusion Ortho-Tec
